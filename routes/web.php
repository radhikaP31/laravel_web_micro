...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/products/spare-parts-of-mud-pump', 'home')->name('mudpumpspareparts');
    Route::get('/products/high-pressure-car-washer', 'home')->name('carwasher');
    Route::get('/sitemap', 'sitemap')->name('sitemap'); //Display sitemap
});
