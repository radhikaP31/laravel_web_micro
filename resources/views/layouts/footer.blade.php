      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/download'; ?>">Download</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/contact-us'; ?>">Contact</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/sitemap'; ?>">Sitemap</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-4 col-md-6 footer-links">
          ...
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/product/1'; ?>">Homogenizers</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/product/2'; ?>">Hygienic Centrifugal Pumps</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/product/1/8'; ?>">Homogenizer Spare Parts</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/product/10/12'; ?>">Food & Tank Cleaning Systems</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/product/8/6'; ?>">Sanitary Filters & Strainers</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo config('app.base_url') . '/product/3'; ?>">Plate Heat Extension</a></li>
        ...
        <div class="col-lg-4 col-md-6 footer-links">
          ...
          <ul>
            <li><span class="text-white" style="margin-right: 4%;"><i class="fa fa-phone fa-rotate-90"></i><a class="letter-spacing text-justify font-family-sans-serif pb-2 text-gray hover-mail"  href="tel://+91-70168 65019">+91 70168 65019</a></span></li>
  ...
  <div class="d-md-flex primary-bg" style="padding: 14px 35px 14px 35px;">
    ...
    <div class="mr-md-auto text-center text-md-left container">
      <div class="copyright text-white">
        <p class="text-center" style="letter-spacing: 0.9px;">&copy; Copyright <?php echo date('Y') ?> - All rights reserved by <strong><span>Microfluid Process Equipment</span></strong></p>
      </div>
    </div>
  </div>
</footer>
